...
This repo requires `Scarb 2.4.0`
This repo requires `sn-foundery 0.13.1`
...
```
curl -L https://raw.githubusercontent.com/foundry-rs/starknet-foundry/master/scripts/install.sh | sh -s -- -v 0.13.1
